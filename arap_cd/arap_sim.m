...
%   Detailed explanation goes here
    ...
    sim.step = @(u, u_hist, f_ext) step(u, u_hist, f_ext,  sim.params, sim.solver_params, sim.spre  );
end

function u_next = step(u, u_hist, f_ext,  sim_params, solver_params, spre )
    dpre = arap_dynamic_precompute( u_hist,  sim_params, spre, f_ext);
